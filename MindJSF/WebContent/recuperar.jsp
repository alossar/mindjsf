...
<title>Recuperar Contraseña - Mind Management</title>
<style type="text/css">
body {
	padding-top: 70px;
	padding-bottom: 40px;
		...
		<div class="container">
			<h:form styleClass="form-signin">
				...
				<h:inputText id="correo" required="true"
					...
					value="#{loginController.correoRecuperar }">
					<f:validateRegex
				...
				<center>
					<h:commandButton id="recuperar" value="Recuperar"
						action="#{loginController.recuperarContrasena }"
