				...
				<div id="contenedorHome" style="height: 500px;">
					...
					<div class="homeShow" id="programarProcesoPD">
						...
						<div class="descripcionP">
							<p>Aquí creará y programará la hora, fecha, los evaluados y
								los temas que desea asignar para la evaluación</p>
						</div>
						<div class="dashBots">
							<h:form>
					...
					<h:panelGroup rendered="#{autorizacionController.cliente }">
						<div class="homeShow" id="programarProcesoPD">
							...
							<h2>Prueba</h2>
							<div class="descripcionP">
								<p>Crea y personaliza tus temas para cualquier situación que
					...
					<div class="homeShow" id="programarProcesoPD">
						...
						<h2>Evaluados</h2>
						<div class="descripcionP">
							<p>Aquí se gestiona la creación y edición de información para
